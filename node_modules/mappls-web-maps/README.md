...
| ---- | ---- | ---- | ---- |
| 3.8.1 | 17 Jun 2026 | MapmyIndia API Team  | Initial Commit |
...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    const loadObject = {
      ...
      //style:'dark-classic' /*You can provide the name of your assigned style list.*/
    };
...
```
 ...
 - Plugins
    ...
    - [placeDetails-Plugin](https://github.com/mappls-api/mappls-web-maps/tree/main/plugins/place-details-plugin)
